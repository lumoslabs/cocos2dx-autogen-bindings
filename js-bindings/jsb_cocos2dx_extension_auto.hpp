...
void js_cocos2dx_extension_Bone_finalize(JSContext *cx, JSObject *obj);
...
JSBool js_cocos2dx_extension_Bone_Bone(JSContext *cx, uint32_t argc, jsval *vp);
...
void js_cocos2dx_extension_ArmatureAnimation_finalize(JSContext *cx, JSObject *obj);
...
JSBool js_cocos2dx_extension_ArmatureAnimation_ArmatureAnimation(JSContext *cx, uint32_t argc, jsval *vp);

extern JSClass  *jsb_ArmatureDataManager_class;
extern JSObject *jsb_ArmatureDataManager_prototype;

JSBool js_cocos2dx_extension_ArmatureDataManager_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_cocos2dx_extension_ArmatureDataManager_finalize(JSContext *cx, JSObject *obj);
...
void js_cocos2dx_extension_Armature_finalize(JSContext *cx, JSObject *obj);
...
JSBool js_cocos2dx_extension_Armature_Armature(JSContext *cx, uint32_t argc, jsval *vp);
...
void js_cocos2dx_extension_Skin_finalize(JSContext *cx, JSObject *obj);
...
JSBool js_cocos2dx_extension_Skin_Skin(JSContext *cx, uint32_t argc, jsval *vp);
