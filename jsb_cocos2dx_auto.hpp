...
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_GLProgram_fragmentShaderLog(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_GLProgram_vertexShaderLog(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Node_nodeToWorldTransform(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Node_getScriptHandler(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Node_unregisterScriptHandler(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Node_nodeToParentTransform(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_Node_numberOfRunningActions(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Node_boundingBox(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Node_registerScriptHandler(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Node_worldToNodeTransform(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_Node_parentToNodeTransform(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Animation_addSpriteFrameWithFileName(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_ActionManager_numberOfRunningActionsInTarget(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CallFunc_initWithTarget(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Camera_setEyeXYZ(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_Camera_setCenterXYZ(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Camera_setUpXYZ(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Sprite_isFlipX(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Sprite_setFlipY(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_Sprite_setFlipX(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Sprite_isFlipY(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_SpriteBatchNode_insertChild(JSContext *cx, uint32_t argc, jsval *vp);
...
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_Layer_unregisterScriptTouchHandler(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Layer_unregisterScriptAccelerateHandler(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Layer_getScriptKeypadHandlerEntry(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Layer_getScriptTouchHandlerEntry(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Layer_registerScriptKeypadHandler(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_LayerColor_isOpacityModifyRGB(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_LayerColor_setOpacityModifyRGB(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_MenuItem_unregisterScriptTapHandler(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_MenuItem_isEnabled(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_MenuItem_setOpacityModifyRGB(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_MenuItem_getScriptTapHandler(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_MenuItem_isOpacityModifyRGB(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_MenuItem_registerScriptTapHandler(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_MenuItemFont_fontNameObj(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_MenuItemFont_initWithString(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_MenuItemFont_fontSizeObj(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_MenuItemFont_fontName(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_MenuItemFont_fontSize(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_MenuItemSprite_isOpacityModifyRGB(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_MenuItemSprite_setOpacityModifyRGB(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_MenuItemToggle_isOpacityModifyRGB(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_MenuItemToggle_setOpacityModifyRGB(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_MenuItemToggle_selectedItem(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Menu_setHandlerPriority(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_ProgressTimer_isOpacityModifyRGB(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_ProgressTimer_setOpacityModifyRGB(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_ParticleSystem_getOpacityModifyRGB(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Application_sharedApplication(JSContext *cx, uint32_t argc, jsval *vp);
...
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_AnimationCache_animationByName(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_SpriteFrameCache_spriteFrameByName(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_TextureCache_addETCImage(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_TextureCache_addUIImage(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_TextureCache_removeTextureForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_TextureCache_textureForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_TextureCache_snapshotTextures(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_TextureCache_addPVRImage(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_TMXObjectGroup_objectNamed(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_TMXObjectGroup_propertyNamed(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_TMXMapInfo_getStoringCharacters(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_TMXMapInfo_formatWithTMXFile(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_TMXMapInfo_formatWithXML(JSContext *cx, uint32_t argc, jsval *vp);
...
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_TMXTiledMap_propertiesForGID(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_TMXTiledMap_objectGroupNamed(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_TMXTiledMap_layerNamed(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_TMXTiledMap_getMapOrientation(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_TMXTiledMap_propertyNamed(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Timer_timerWithScriptHandler(JSContext *cx, uint32_t argc, jsval *vp);
