...
JSBool js_cocos2dx_extension_CCBAnimationManager_setSpeed(JSContext *cx, uint32_t argc, jsval *vp)
{
	jsval *argv = JS_ARGV(cx, vp);
	JSBool ok = JS_TRUE;
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	...
	if (argc == 1) {
		double arg0;
        ok &= JS_ValueToNumber(cx, argv[0], (double*)&arg0);
		JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
		cobj->setSpeed(arg0);
		JS_SET_RVAL(cx, vp, JSVAL_VOID);
		return JS_TRUE;
...
JSBool js_cocos2dx_extension_CCBAnimationManager_getSpeed(JSContext *cx, uint32_t argc, jsval *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	js_proxy_t *proxy = jsb_get_js_proxy(obj);
	cocos2d::extension::CCBAnimationManager* cobj = (cocos2d::extension::CCBAnimationManager *)(proxy ? proxy->ptr : NULL);
...
void js_register_cocos2dx_extension_CCBAnimationManager(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec funcs[] = {
        ...
        JS_FN("getSpeed", js_cocos2dx_extension_CCBAnimationManager_getSpeed, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("setSpeed", js_cocos2dx_extension_CCBAnimationManager_setSpeed, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FS_END
	};
